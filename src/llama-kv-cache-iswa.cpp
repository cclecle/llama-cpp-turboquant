...
llama_kv_cache_iswa::llama_kv_cache_iswa(
    ...
    llama_kv_cache_iswa(model, model.hparams, type_k, type_v, v_trans, offload, swa_full, unified,
            kv_size, n_seq_max, n_ubatch, n_pad, mem_other, filter, reuse, share, n_cpu_kv_cells) {
}
...
llama_kv_cache_iswa::llama_kv_cache_iswa(
    ...
    const  layer_reuse_cb & reuse,
    const  layer_share_cb & share,
                 uint32_t   n_cpu_kv_cells) : unified(unified) {
    ...
    kv_base = std::make_unique<llama_kv_cache>(
            ...
            0, LLAMA_SWA_TYPE_NONE, mem_other_base, filter_base, reuse, share, 0, n_cpu_kv_cells);
    ...
    kv_swa = std::make_unique<llama_kv_cache>(
            ...
            hparams.n_swa, hparams.swa_type, mem_other_swa, filter_swa, reuse, share, 0, 0);
}
